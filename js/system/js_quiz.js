EventUtil.addHandler(window, "load", function() {
	...
	loadQuestion = function() {
		document.getElementById("question").innerHTML = "<div data-question="+data.questions.indexOf(data.questions[i])+"><img src='../images/system/hover/question"+ data.questions.indexOf(data.questions[i]) + "-hover.png'/></div>";
